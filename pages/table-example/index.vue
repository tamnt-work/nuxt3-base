<template>
  <div class="table-example-page">
    <the-container size="lg">
      <the-heading>{{ $t('pages.tableExample.title') }}</the-heading>
      <div class="mt-4">
        <the-table
          :data="dataList"
        ...
        >
          ...
          <template #toolbar-suffix>
            <the-button
              ...
              >{{ $t('common.actions.add') }}</the-button
            >
          </template>
              ...
              <template #after>
                <the-table-filter-setting>
                  <el-row :gutter="16" class="mt-4">
                    ...
                    <el-col :xs="24" :sm="6">
                      <the-form-item :label="$t('pages.users.content.name')">
                        <the-input v-model="filter.name" size="default" />
                      </the-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="6">
                      <the-form-item
                        :label="$t('pages.users.content.calculatorName')"
                      >
                        <the-input
                          v-model="filter.calculatorName"
                          size="default"
                        />
                      </the-form-item>
                    </el-col>
          ...
          <template #columns>
            <el-table-column
              ...
              :label="$t('pages.tableExample.content.registrationDate')"
              width="180"
            />
            <el-table-column
              prop="name"
              :label="$t('pages.tableExample.content.name')"
              width="180"
            />
            <el-table-column
              prop="registeredPerson"
              :label="$t('pages.tableExample.content.registeredPerson')"
            />
            <el-table-column
              prop="other"
...
useHead({
  title: t('pages.tableExample.title'),
})
...
@import '@/assets/styles/pages/table-example/index.scss';
</style>
